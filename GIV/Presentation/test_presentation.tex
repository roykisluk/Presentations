...
\begin{frame}[shrink,label=src_assumptions]
    \frametitle{A simple model of aggregate and idiosyncratic shocks}

    Consider an economy with $N$ firms. \hyperlink{app_assumptions}{\beamergotobutton{Assumptions}}
...
\begin{frame}[label=src_psi_identification]
    ...
    \vspace{0.5cm}
    Using the supply equation, $\mathbb{E}[(w_t - \psi L_{St}) z_t] = 0$: \hyperlink{app_psi_identification}{\beamergotobutton{Proof}}
    \begin{equation*}
...
\begin{frame}[label=app_assumptions]{Assumptions}
    \vspace{-0.5em}
...
\begin{frame}[shrink,label=app_sqrtn]
...
\begin{frame}[shrink,label=app_size_weighted]
...
\begin{frame}[shrink,label=app_equal_weighted]
...
\begin{frame}[shrink,label=app_psi_identification]
...
\begin{frame}[shrink,label=app_simple_giv_fails]
...
\begin{frame}[shrink,label=app_propositions]{Granular Instrumental Variables isolate idiosyncratic shocks}
    \vspace{0.2cm}
    \centering
...
\begin{frame}[shrink]{Moment conditions link structural equations to the GIV}
    \vspace{0.5cm}
    \centering
...
\begin{frame}[shrink]{Proposition 1: The GIV estimator is asymptotically consistent}
    \vspace{0.5cm}
    \centering
...
\begin{frame}[shrink]{Pass-through multipliers capture shock amplification}
    \vspace{0.5cm}
    \centering
...
\begin{frame}[shrink]{Proposition 2: Asymptotic variance scales with aggregate noise}
    \vspace{0.5cm}
    \centering
...
\begin{frame}[shrink]{High idiosyncratic volatility improves estimator precision}
    \vspace{0.5cm}
    \centering
...
\begin{frame}[shrink]{Proposition 3: Optimal weights use an orthogonal projection}
    \vspace{0.5cm}
    \centering
