...
\begin{frame}
    ...
    \vspace{1cm}
    {\Large
        When a dominant employer experiences an unexpected surge in productivity, wages often respond.
    }

    \vspace{1cm}
    {\Large
        How much of that response is causal, and how much is driven by common macroeconomic trends?
    }
